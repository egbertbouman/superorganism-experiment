# Vendored from Tribler/py-ipv8 scripts/tracker_service.py — see py-ipv8 docs §"Bootstrapping".
"""
...
# Vendor divergence from upstream: ipv8.REST.{base_endpoint,rest_manager} are
